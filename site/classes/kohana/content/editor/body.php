...
class Kohana_Content_Editor_Body extends Editor_Element_CKE_Extended {

	public function __construct( )
	{
		parent::__construct('site_contents', 'body_'.Site::get_language( ));
	}
	...
	protected function prepare( )
	{
		...
		// write to access log
		Access_Log::instance( )->write("Пользователь <b>{$user->login}</b> редактировал тело страницы <a href='{$item->uri}'>{$item->uri}</a>");
