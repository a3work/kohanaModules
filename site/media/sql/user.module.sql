...
--
-- Хост: localhost
-- Время создания: Ноя 07 2013 г., 12:56
-- Версия сервера: 5.5.33-1
-- Версия PHP: 5.5.5-1
...
--
-- Структура таблицы `cli_processes`
--

CREATE TABLE IF NOT EXISTS `cli_processes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` mediumint(9) DEFAULT NULL,
  `tag` varchar(32) NOT NULL COMMENT 'one tag execute at moment',
  `chain` varchar(32) NOT NULL DEFAULT '' COMMENT 'define process sequence',
  `task` varchar(255) NOT NULL DEFAULT '' COMMENT 'executed command',
  `param` varchar(1024) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL DEFAULT '',
  `memory_usage` int(11) NOT NULL DEFAULT '0',
  `processed` mediumint(9) NOT NULL DEFAULT '0' COMMENT 'processed records count',
  `progress` float DEFAULT NULL COMMENT 'progress of process execution',
